...
<html>
<head>
<title>Writing Live - Watching writers write</title>
					...
					<div class="col-md-8 top-nav">
					  <span class="menu"> <img src="images/icon.png" alt=""></span>
						<ul class="res">
							...
							<li><a class="active" href="#"><i class="glyphicon glyphicon-cog"> </i> Live Stories</a></li>
		    ...
		    <div class="inner-content">
			  <!--web-forms-->
				...
				<div class="copy-right">
						<p>Copyright &copy; 2016 Arshem Web Solutions. All rights Reserved</p>
				</div>
	<!--//end-copyright-->
